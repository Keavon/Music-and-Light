...
public class Keystoning : MonoBehaviour {
	...
	void Update() {
		...
		// Output switching
		if (mouseIsOverArea && Input.GetKey(KeyCode.LeftShift) && (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Keypad1))) {
			cam.targetDisplay = 1;
			ReinitializeDisplayOutputs();
		}
		if (mouseIsOverArea && Input.GetKey(KeyCode.LeftShift) && (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Keypad2))) {
			cam.targetDisplay = 2;
			ReinitializeDisplayOutputs();
		}
		if (mouseIsOverArea && Input.GetKey(KeyCode.LeftShift) && (Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Keypad3))) {
			cam.targetDisplay = 3;
			ReinitializeDisplayOutputs();
		}
